...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'application-form/:scholarshipId', component: () => import('pages/ApplicationFormPage.vue'), meta: { requiresAuth: true } },
      ...
      { path: 'essay-form/:essayId', component: () => import('pages/EssayFormPage.vue'), meta: { requiresAuth: true } },
      ...
      { path: 'recommender-form/:recommenderId', component: () => import('pages/RecommenderFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'recommendation-form', component: () => import('pages/RecommendationFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'recommendation-form/:recommendationId', component: () => import('pages/RecommendationFormPage.vue'), meta: { requiresAuth: true } },
    ]
  },
  {
    path: '/:catchAll(.*)*',
