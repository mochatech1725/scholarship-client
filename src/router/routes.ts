...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'essay-form', component: () => import('pages/EssayPage.vue'), name: 'essayCreate', meta: { requiresAuth: true } },
      { path: 'essay-form/:essayId', component: () => import('pages/EssayPage.vue'), name: 'essayEdit', meta: { requiresAuth: true } },
      { path: 'recommenders', component: () => import('pages/RecommendersPage.vue'), name: 'recommendersList', meta: { requiresAuth: true } },
      { path: 'recommender-form', component: () => import('pages/RecommenderPage.vue'), name: 'recommenderCreate', meta: { requiresAuth: true } },
      { path: 'recommender-form/:recommenderId', component: () => import('pages/RecommenderPage.vue'), name: 'recommenderEdit', meta: { requiresAuth: true } },
      { path: 'recommendation-form', component: () => import('pages/RecommendationPage.vue'), name: 'recommendationCreate', meta: { requiresAuth: true } },
      { path: 'recommendation-form/:recommendationId', component: () => import('pages/RecommendationPage.vue'), name: 'recommendationEdit', meta: { requiresAuth: true } },
    ]
  },
  {
    path: '/:catchAll(.*)*',
